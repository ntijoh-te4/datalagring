...
Både kryptering i vila och kryptering vid överföring sker på _infrastrukturnivå_ — databasen själv ser klartext. De skyddar mot stulna diskar och avlyssning på nätverket, men _inte_ mot:
...
För riktigt känsligt innehåll väljer en del tjänster — t.ex. https://basecamp.com[Basecamp]/HEY för e-post och projektinnehåll, https://signal.org[Signal] för meddelanden, eller lösenordshanterare som https://1password.com[1Password] — att kryptera datan _innan_ den når databasen. Databasen lagrar då bara obegripliga teckensträngar; bara applikationen (med rätt nyckel) kan dekryptera dem.
