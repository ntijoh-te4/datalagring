...
* *Dokumentdatabaser* lagrar JSON-liknande dokument. Exempel: https://www.mongodb.com/[MongoDB], https://couchdb.apache.org/[CouchDB], https://www.elastic.co/elasticsearch[Elasticsearch].
* *Nyckel-värde-databaser* lagrar enkla nyckel-värde-par. Exempel: https://redis.io/[Redis], https://aws.amazon.com/dynamodb/[DynamoDB].
* *Kolumndatabaser* organiserar data per kolumn istället för per rad. Exempel: https://cassandra.apache.org/[Cassandra], https://hbase.apache.org/[HBase].
* *Grafdatabaser* lagrar noder och kanter, optimerade för nätverksstrukturer. Exempel: https://neo4j.com/[Neo4j], https://arangodb.com/[ArangoDB].
