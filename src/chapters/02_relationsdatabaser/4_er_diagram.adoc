...
.Två entiteter
image::02_relationsdatabaser/img/entities.png[]
...
image::02_relationsdatabaser/img/entities_with_attributes.png[]
...
image::02_relationsdatabaser/img/entities_with_attributes_and_relations.png[]
